...
print('./Figure/Dendrogram_ColorLabels.png','-dpng','-r300');
...
set(gca,'Fontsize',11);
print('./Figure/Dendrogram_Numbers.png','-dpng','-r300');
...
print(gcf,['./Figure/FCsim_btwn_Communities_hierarchical.png'],'-dpng','-r300');
close;
%% Plot legend
